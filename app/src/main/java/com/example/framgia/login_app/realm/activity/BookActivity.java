...
public class BookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get realm instance
        this.realm = RealmController.get().getRealm();
...
//        setSupportActionBar(toolbar);
        ...
        setRealmAdapter(RealmController.get().getBooks());
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                inflater = BookActivity.this.getLayoutInflater();
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (editTitle.getText() == null || editTitle.getText().toString().equals("") || editTitle.getText().toString().equals(" ")) {
                                    Toast.makeText(BookActivity.this, "Entry not saved, missing title", Toast.LENGTH_SHORT).show();
                                } else {
